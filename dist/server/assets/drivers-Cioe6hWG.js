import { V as React, r as reactExports, W as jsxRuntimeExports } from "./server-UNqwmoql.js";
import { c as createLucideIcon, u as useStore, t as toast, U as Users } from "./router-C1HWRFUk.js";
import { U as UserPlus } from "./user-plus-TpPX7V2E.js";
...
const schema = objectType({
  name: stringType().min(2, "Imię musi mieć min. 2 znaki").max(40, "Maks. 40 znaków").regex(/^[\p{L}\s'-]+$/u, "Tylko litery, spacje, '-'"),
  handle: stringType().min(2, "Pseudonim min. 2 znaki").max(20, "Maks. 20 znaków").regex(/^@?[a-zA-Z0-9_]+$/, "Tylko litery, cyfry i _")
});
const Field = reactExports.forwardRef(function Field2({ id, label, error, ...rest }, ref) {
  const errId = `${id}-err`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: id, className: "flex flex-col gap-1", children: [
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: errId, role: "alert", className: "text-xs text-destructive", children: error })
  ] });
});
function DriverForm() {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      const exists = users.some(
        (u2) => u2.handle.toLowerCase() === handle.toLowerCase() || u2.name.toLowerCase() === values.name.trim().toLowerCase()
      );
      if (exists) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "glass rounded-xl p-5", "aria-labelledby": "driver-form-title", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center gap-2 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "h-4 w-4 text-amber", "aria-hidden": true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { id: "driver-form-title", className: "font-display text-lg uppercase tracking-widest", children: "Dodaj kierowcę" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "grid gap-3", noValidate: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Field,
        {
          id: "driver-name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            submitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: submitting ? "Zapisuję…" : "Dodaj" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
        "Łącznie kierowców: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-foreground", children: users.length })
      ] })
    ] })
  ] });
}
function DriversPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-[1fr_1fr] animate-[fade-in_0.4s_ease-out]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DriverForm, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "glass rounded-xl p-5", "aria-labelledby": "drivers-list-title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-4 w-4 text-amber", "aria-hidden": true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { id: "drivers-list-title", className: "font-display text-lg uppercase tracking-widest", children: "Kierowcy" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-border/60", children: users.map((u) => {
        const count = trips.filter((t2) => t2.userId === u.id).length;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center justify-between py-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: u.handle })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-sm text-amber", children: [
            count,
            " przej."
          ] })
        ] }, u.id);
