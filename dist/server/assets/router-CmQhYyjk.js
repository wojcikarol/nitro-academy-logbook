...
function StoreProvider({ children }) {
  ...
  const status = !isConvexConfigured ? "error" : appData === void 0 ? "loading" : seeded ? "success" : "error";
  ...
  const value = {
    ...
    selectCar: (id) => {
      ...
      setSelectedCarMutation({ carId: id }).catch((error2) => {
    ...
    cycleCar: (dir) => {
      ...
      if (nextCar) {
        setSelectedCarMutation({ carId: nextCar.id }).catch((error2) => {
    ...
    setRouteDistance: (km) => {
      if (!isConvexConfigured) return;
      setRouteDistanceMutation({ distance: clampDistance(km) }).catch((error2) => {
...
const $$splitComponentImporter$5 = () => import("./stats-DWXdjuoS.js");
...
const $$splitComponentImporter$4 = () => import("./settings-TkZvB3YJ.js");
...
const $$splitComponentImporter$3 = () => import("./history-DayboWGp.js");
...
const $$splitComponentImporter$2 = () => import("./garage-DekknwL4.js");
...
const $$splitComponentImporter$1 = () => import("./drivers-Bot03kdI.js");
...
const $$splitComponentImporter = () => import("./index-Bo4p_J3H.js");
